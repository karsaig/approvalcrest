...
public class SameContentTest {
    ...
    @Test
    public void runWithMethodInjectionShouldPassWithMatchingApprovedFile(Method method) {
        String actual = "Test content with method injection";

        assertThat(actual, sameContentAsApproved(method));
    }
}
