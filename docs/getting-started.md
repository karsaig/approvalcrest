...
|---|---|
| JUnit 4 / JUnit 5 Vintage | `com.github.karsaig:approvalcrest:1.4.1` |
| JUnit 5 & 6 Jupiter (Java) | `com.github.karsaig:approvalcrest-junit-jupiter:1.4.1` |
| Kotlin + JUnit 5 & 6 | `com.github.karsaig:approvalcrest-junit-jupiter-kotlin:1.4.1` |
| TestNG | `com.github.karsaig:approvalcrest-testng:1.4.1` |
