...
public class JsonThrowableSupportTest extends AbstractFileMatcherTest {
        ...
        return new Object[][]{
                ...
                {new RuntimeException("X differs:", new IllegalStateException("This is bad!")), "{\n" +
                        ...
                        "\n" +
                                ...
                                "  \"class\": \"java.lang.RuntimeException\"\n" +
                                "}\n" +
                                "     but: Expected file 4ac405/11b2ef-approved.json\n" +
                                "detailMessage\n" +
                                "Expected: X:\n" +
                                "     got: X differs:\n"},
    ...
    void exceptionHandlingTest(Object input, String expected, String expectedExceptionMessage) {
        inMemoryFsWithDummyTestInfo(input, expected, expectedExceptionMessage);
    }
}
